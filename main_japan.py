...
# Step 1: Fetch and save 2025 Japanese GP qualifying data
qualifying_path = "data/qualifying_japan_2025.csv"
if not os.path.exists(qualifying_path) or os.path.getsize(qualifying_path) == 0:
    try:
        print("Loading 2025 Japanese GP Qualifying Data...")
...
# Step 2: Load race session data from 2024 Japanese GP
print("\nLoading 2024 Japanese GP Race Data...")
session = load_session(2024, "Japan")
...
if not qualifying_2025.empty:
    ...
    final_results.to_csv("predictions/prediction_japan_2025.csv", index=False)
    ...
    # Save MAE to file
    with open("predictions/mae_japan_2025.txt", "w") as f:
