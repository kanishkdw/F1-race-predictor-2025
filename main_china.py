...
# Step 1: Fetch and save 2025 Chinese GP qualifying data
qualifying_path = "data/qualifying_china_2025.csv"
if not os.path.exists(qualifying_path) or os.path.getsize(qualifying_path) == 0:
    try:
        print("Loading 2025 Chinese GP Qualifying Data...")
...
# Step 2: Load race session data from 2024 Chinese GP
print("\nLoading 2024 Chinese GP Race Data...")
session = load_session(2024, "China")
...
if not qualifying_2025.empty:
    ...
    final_results.to_csv("predictions/prediction_china_2025.csv", index=False)
    ...
    # Save MAE to file
    with open("predictions/mae_china_2025.txt", "w") as f:
